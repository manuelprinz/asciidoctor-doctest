  ...
  module XML
    class Converter < AsciidocConverter
      ...
      def normalize(content)
        ...
        #if !has_content_type && content.is_a?(Nokogiri::XML::Document)
      ...
      def find_nodes(html, xpaths)
        Array(xpaths).reduce(html) do |htm, xpath|
          ...
          parse_xml htm.xpath(xpath).to_xml
        end
      end
      ...
      #
      # @param html [Nokogiri::XML::Document, Nokogiri::XML::DocumentFragment]
